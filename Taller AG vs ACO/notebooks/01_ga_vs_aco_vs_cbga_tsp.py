...
def main():
    ...
    # 1) Cargar instancias
    instances = [
        load_tsp("data/eil51.tsp", opt_known=None),
        load_tsp("data/berlin52.tsp", opt_known=None),
        load_tsp("data/st70.tsp", opt_known=None),
    ]
    ...
    # Para tuning usar solo 2 instancias
    ...
    # 5) Seleccionar mejores configs (objetos)
    best_algorithms = []
